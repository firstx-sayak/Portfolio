...
const WorkflowSolutionsSection = ({ formData, setFormData, handleFormSubmit }) => (
  ...
  >
    <div className="container mx-auto px-6">
      ...
      <div className="max-w-2xl mx-auto bg-gradient-to-b from-gray-900/82 to-black/80 p-8 rounded-2xl border border-red-500/30 shadow-2xl backdrop-blur-sm transition-transform duration-500">
